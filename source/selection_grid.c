...
void selection_grid_move_selection_horz(SelectionGrid* selection_grid, int direction_tribool)
{
    ...
    if(selection_grid->selection.y >= 0 && selection_grid->selection.y < selection_grid->num_rows &&
       new_selection.x >= 0 && new_selection.x < selection_grid->rows[new_selection.y].get_size())
    {
