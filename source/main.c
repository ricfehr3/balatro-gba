...
extern const TFont my_sys8Font;
extern const unsigned int my_sys8Glyphs[192];
...
void init()
{
    ...
    tte_init_se(0, BG_CBB(TTE_CBB) | BG_SBB(TTE_SBB), 0, CLR_WHITE, TTE_BIT_UNPACK_OFFSET, &my_sys8Font, NULL);
    tte_erase_screen();
    tte_init_con();
